...
class Grid:
        ...
        if row == 2:
            ...
            if col == 2:
                if len(self.grid) > 1 and self.grid[1][col - 1] == "O":
                    self.RenderMonster(self.sprites[0])
                elif len(self.grid) > 2 and self.grid[2][col - 1] == "O":
                    self.RenderMonster(self.sprites[1])
                elif len(self.grid) > 3 and self.grid[3][col - 1] == "O":
                    self.RenderMonster(self.sprites[2])
    ...
    def RenderMonster(self, sprite):
        for i in range(20):
            for j in range(20):
                if sprite[i][j] != "*":
                    self.view[i][j] = sprite[i][j]
